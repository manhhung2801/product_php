        ...
        <div class="bg-light py-4">
                <div class="container product_data mt-3">
                        <div class="row">
                                <div class="col-md-4">
                                    <div class="shadow">
                                            <img src="uploads/<?= $product["image"]; ?>" alt="Product Image" class="w-100" height="500px">
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <h4 class="fw-bold"></h4><?= $product["name"]; ?>
                                    <span class="float-end text-danger"></span> <?php if($product["trending"]) {echo "Trending"; } ?></span>
                                </h4>
                                    <hr>
